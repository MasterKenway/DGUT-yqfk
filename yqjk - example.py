...
PHPSESSID = origin.cookies['PHPSESSID']
...
cookies = { "languageIndex":"0","last_oauth_appid":"illnessProtectionHome", "last_oauth_state":"home", "PHPSESSID":PHPSESSID}
...
form = {"submit_time":time_fmt,
        ...
        "plan_details":"null",
        "card_type":49,
        "huji_region":[142,440000,,],
        "jiguan_region":[142,440000,,],
        "family_region":[142,440000,,],
...
PHPSESSID = yqjk_session.cookies['PHPSESSID']
...
yqjk_page = yqjk_session.get(url = yqjk_acesstoken.url)
